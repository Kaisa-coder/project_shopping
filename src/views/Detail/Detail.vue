  ...
  methods: {
    ...
    async addShopCar () {
      try {
        ...
        // 路由跳转 并且传递产品信息给 addCartSuccess
        // 传递简单的数据(skuNum) 通过query形式给路由传递过去 传递复杂的信息(skuInfo)，通过sessionStorage传递
        // sessionStorage和localStorage一般存储的是字符串
