...
export default {
  ...
  methods: {
    ...
    async open () {
      ...
      const url = await QRCode.toDataURL('wxp://f2f0FLU3j5irZii-pjn98ltNeifYNfZh2fKXH6273hh2aV0')
      this.$alert(`<img src=${url} />`, '请你微信支付', {
        // 是否将message 属性作为 HTML 片段处理
        ...
        beforeClose: (type, instance, done) => {
          // type区别取消和确认按钮 instance 当前组件实例 done 关闭弹出框的方法
          if (type === 'cancel') {
            alert('请联系管理员')
